...
- When building a frozen executable on Windows, the multiprocessing 'spawn' start method
  will import the main module in child processes.
- If the app starts at import time, it can cause recursive launches / crashes.

This file provides a clean __main__ entrypoint for PyInstaller.
"""
...
def main() -> None:
    ...
    # Shutdown a running instance (used by Start menu shortcut "Ukončit aplikaci")
    ...
    # Manual update check (used by Start menu shortcut "Zkontrolovat aktualizace")
